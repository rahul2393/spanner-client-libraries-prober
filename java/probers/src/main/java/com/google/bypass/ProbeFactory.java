...
final class ProbeFactory {
  ...
  static Probe create(
    ...
    return switch (workload) {
      ...
      case "multi_use_ro_query_inline_begin" ->
          new MultiUseReadOnlyQueryProbe(client, numRows, /* inlineBegin= */ true);
      case "multi_use_ro_read" ->
          new MultiUseReadOnlyReadProbe(client, numRows, /* inlineBegin= */ false);
      case "multi_use_ro_read_inline_begin" ->
          new MultiUseReadOnlyReadProbe(client, numRows, /* inlineBegin= */ true);
